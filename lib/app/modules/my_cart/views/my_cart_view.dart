...
import 'package:simple_shopping_cart_getx/app/modules/my_cart/views/total_page.dart';
          ...
          children: [
            Row(
              children: [
                ...
                Obx(() => Text("${c.books.toString()}", style: TextStyle(
                  fontSize: 30,
                ),)),
                SizedBox(
                  width: 20,
            ...
            Row(
              children: [
                ...
                Obx(() => Text("${c.pens.toString()}", style: TextStyle(
                  fontSize: 30,
                ),)),
                SizedBox(
                  width: 20,
